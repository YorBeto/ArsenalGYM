    ...
    <div>
      <aside class="sidebar">
        ...
        <v-btn 
          ...
          :color="coloresBotones1.inbody"
          @click="navegar('inbody')"
        >InBody</v-btn>
        <v-btn 
          class="botones" 
