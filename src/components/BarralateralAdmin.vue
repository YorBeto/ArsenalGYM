<template>
    <div>
        <aside class="sidebar">
        <router-link to="clientes"><v-btn class="botones" @mouseover="activarColorGris()" @mouseleave="restaurarColorboton()" :color="coloresBotones1">Clientes</v-btn> </router-link> 
